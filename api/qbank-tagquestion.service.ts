...
import { QbankTagquestionSubmitTagsFormRequest } from '../model/qbank-tagquestion-submit-tags-form-request';
import { Configuration } from '../configuration';


@Injectable()
export class QbankTagquestionService {
     ...
     */
    public qbankTagquestionSubmitTagsForm(qbankTagquestionSubmitTagsFormRequest: QbankTagquestionSubmitTagsFormRequest, ): Observable<AxiosResponse<CoreQuestionSubmitTagsForm200Response>>;
    public qbankTagquestionSubmitTagsForm(qbankTagquestionSubmitTagsFormRequest: QbankTagquestionSubmitTagsFormRequest, ): Observable<any> {
        ...
        return this.httpClient.post<CoreQuestionSubmitTagsForm200Response>(`${this.basePath}/qbank_tagquestion_submit_tags_form`,
